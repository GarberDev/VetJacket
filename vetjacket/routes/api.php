...
Route::post('/intake-form/{uuid}', [PatientIntakeController::class, 'store']);
...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/patient-intake-info', [PatientIntakeController::class, 'index']);
    Route::get('/patient-intake-info/{id}', [PatientIntakeController::class, 'show'])->where('id', '[0-9a-fA-F-]{36}');
    Route::put('/patient-intake-info/{id}', [PatientIntakeController::class, 'update'])->where('id', '[0-9a-fA-F-]{36}');
    Route::delete('/patient-intake-info/{id}', [PatientIntakeController::class, 'destroy'])->where('id', '[0-9a-fA-F-]{36}');
});
